<template>
    <div>
        <header>
            <div>
                <img src="./bgimg/语音.png" alt="">
            </div>
            <div class="input_div">
                <input type="text" placeholder="搜索音乐、视频、歌词、电台" @click="seach_inp">
                <img src="./bgimg/搜索.png" alt="" id="seach_icon">
            </div>
            <div>
                <img src="./bgimg/语音.png" alt="">
            </div>
        ...
        <div id="concent">
            <div class="title_div">
                <p>
                    <span @click='indexmusic'>音乐</span>
                </p>
                <p>
                    <span @click="indexvideo">视频</span>
                </p>
                <p>
                    <span>电台</span>
                </p>
...
<script>
    export default {
        ...
        computed: {
            banner() {
                this.$data.banner = this.$store.state.music.bannerArr;
            },
            // 歌单
            lists() {
        ...
        methods: {
            ...
            indexvideo() {
                this.$router.push("/music/index/video");
            },
            // 点击推荐榜单
            figure() {
